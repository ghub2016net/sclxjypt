...
namespace HzsModel.Models
{
    ...
    public partial class AdminRole : Entity<AdminRole>
    {
        ...
        #region 扩展查询﻿
        /// <summary>根据menuid查找</summary>
        /// <param name="__menuid"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<AdminRole> FindAllBymenuid(Int32 __menuid)
        {
            if (Meta.Count >= 1000)
                return FindAll(_.menuid, __menuid);
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(__.menuid, __menuid);
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static AdminRole FindByid(Int32 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<AdminRole> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
