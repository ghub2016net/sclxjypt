...
{
    /// <summary></summary>
    public partial class DM_ZZDW : Entity<DM_ZZDW>
    {
        #region 对象操作﻿
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}DM_ZZDW数据……", typeof(DM_ZZDW).Name);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}DM_ZZDW数据！", typeof(DM_ZZDW).Name);
        //}
        #endregion
        ...
        //public static EntityList<DM_ZZDW> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
