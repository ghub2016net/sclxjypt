...
namespace HzsModel.Models
{
    ...
    public partial class SysLog : Entity<SysLog>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(SysLog).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(SysLog).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static SysLog FindByid(Int64 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<SysLog> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
