...
namespace HzsModel.Models
{
    ...
    public partial class Company : Entity<Company>
    {
        #region 对象操作﻿
        ...
        public static EntityList<Company> FindAllByuid(Int32 __uid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Company FindByid(Int64 __id)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Company> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
