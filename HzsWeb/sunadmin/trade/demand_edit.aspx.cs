...
/// 编辑需求信息
/// </summary>
public partial class sunadmin_trade_demand_edit : HzsWebUI.AdminManage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (String.IsNullOrEmpty(coki))
            Response.Redirect("~" + siteConfig.webpath + siteConfig.webadminpath + "/huser/login.aspx?typeid=20");
