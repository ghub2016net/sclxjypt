<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cooperation.aspx.cs" Inherits="sunadmin_trade_cooperation" %>
...
<script type="text/javascript" src="../js/hik/cooperation.js"></script>
</head>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="cooperation_edit.aspx"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tr>
    ...
    <th align="left" width="24%">合作信息标题</th>
  ...
  <tr>
    ...
    <td align="left"><a href="cooperation_edit.aspx?action=Edit&id=<%=molist[i].id %>">修改</a>&nbsp; <a target="_blank" href="../../show/hezuo.aspx?id=<%=molist[i].id %>">查看</a></td>
  </tr>
  <% } }%>
</table>
