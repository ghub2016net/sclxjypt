<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cooperation_edit.aspx.cs" Inherits="sunadmin_trade_cooperation_edit" %>
...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="../trade/supply.aspx"><span>合作列表</span></a>
  <i class="arrow"></i>
  <span>编辑合作信息</span>
</div>
