...
/// 合作社会员管理
/// </summary>
public partial class sunadmin_huser_huserlist : HzsWebUI.AdminManage
{
    protected Int32 totalCount = default(Int32);//总数
    protected Int32 page = default(Int32);//当前页码
    protected Int32 pageSize = default(Int32);//每页数据数量
    protected String keywords = String.Empty;//搜索关键字
