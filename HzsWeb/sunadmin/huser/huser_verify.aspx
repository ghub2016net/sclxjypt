<%@ Page Language="C#" AutoEventWireup="true" CodeFile="huser_verify.aspx.cs" Inherits="sunadmin_huser_huser_verify" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>合作社会员审核管理</title>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      ...
      <div class="menu-list">
        <div class="rule-single-select">
          <select name="ddlIsverify" onchange="javascript:;" id="ddlIsverify">
	        <option value="">=站内审核=</option>
	        <option value="10">审核</option>
            <option value="20">待审核</option>
            <option value="40">审核失败</option>
        </select>
         </div>
      </div>
    </div>
    <div class="l-list">
      <ul class="icon-list">
        <li><a onclick="return ExePostBack('btnShow','执行站内审核通过，是否继续？');" id="btnShow" class="save" href="javascript:;"><i></i><span>站内审核</span></a></li>
        <li><a onclick="return ExePostBack('btnShowOut','执行站内审核通过，是否继续？');" id="btnShowOut" class="save" href="javascript:;"><i></i><span>申请站外审核</span></a></li>
      </ul>
      </div>
    <div class="r-list">
