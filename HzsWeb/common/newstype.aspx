<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newstype.aspx.cs" Inherits="common_newstype" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        callback: function () {
            if(tt=="hik")
                api.opener.document.location.href="/AjaxNewsType/ToListUrl.ashx?l="+trid;
        }
    }, {
        name: '取消'
    });
