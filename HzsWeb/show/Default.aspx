<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="show_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>编辑供应内容信息</title>
...
<script type="text/javascript" src="../sunadmin/js/hik/trade_edit.js"></script>
...
<!--导航栏-->
<div class="location">
  <a href="javascript:;"><span>供应列表</span></a>
  <i class="arrow"></i>
  <span>编辑供应信息</span>
</div>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected">供应信息 页1</a></li>
        <li><a href="javascript:;" onclick="tabs(this);">供应信息 页2</a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-multi-radio">
        ...
        <script type="text/javascript">
            var ck = "<%=mo.isverify%>"; if (ck == 0) { $("[name='isverify']:eq(0)").attr("checked", "true"); } else { $("[name='isverify']").each(function () { if ($(this).val() == ck) $(this).attr("checked", "true") }) }
        </script>
      </div>
    </dd>
  </dl>
  ...
  <dl>
    ...
    <script>
        $(function () {
            ...
            //加载小类
            $("#ddlptype2").empty();
            var provincezhi = $("#ddlptype").val();
            $.each(arrarea, function (a, b) {
                if (b.pid == provincezhi) {
                    $("#ddlptype2").append("<option value='" + b.oid + "'>" + b.oname + "</option>");
                }
            });
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    <dt>到期时间</dt>
    <dd>
    <%string lastdate = ""; if (mo.daytime != null) { lastdate = mo.daytime.ToString("yyyy-MM"); } %>
      <div class="input-date">
      ...
      <span class="Validform_checktip">*供应信息到期时间 例：(2018-06)=(2018-06-01)</span>
    </dd>
  </dl>
  <dl>
    <dt>内容摘要</dt>
...
<div><input type="hidden" name="uid" value="<%=mo.uid %>" /></div>
<!--/内容-->
