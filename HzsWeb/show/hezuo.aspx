<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hezuo.aspx.cs" Inherits="show_hezuo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>编辑合作内容信息</title>
...
<!--导航栏-->
<div class="location">
  <a href="javascript:;"><span>合作列表</span></a>
  <i class="arrow"></i>
  <span>编辑合作信息</span>
</div>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected">合作信息 页1</a></li>
        <li><a href="javascript:;" onclick="tabs(this);">合作信息 页2</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <%string lastdate = ""; if (mo.daytime != null) { lastdate = mo.daytime.ToString("yyyy-MM"); } %>
      ...
      <span class="Validform_checktip">*合作信息到期时间 例：(2018-06)=(2018-06-01)</span>
    </dd>
  </dl>
  <dl>
    <dt>内容摘要</dt>
