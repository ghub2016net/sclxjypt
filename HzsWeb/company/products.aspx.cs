...
public partial class company_products : MyMVC.MyBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["uid"] != null)
        {
            ...
            //新闻信息
            rptXinwen.DataSource = DbHelper.FillList<Company>("select TOP 6 uid,id, content, title,pic, addtime FROM Company where typeid=3 and uid=" + uid + "ORDER BY addtime DESC ", null, CommandKind.SqlTextNoParams);
            rptXinwen.DataBind();
            //产品展示
