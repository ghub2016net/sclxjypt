<%@ Page Language="C#" AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="company_products" %>
...
<div class="hcontents">
    ...
    <div class="hR2">
        ...
        <div class="himgScrollCenter" id="roll">
            ...
            <a target="_blank"  style="text-align:center; margin:auto" href="prodectdetail.aspx?&uid=<%=hzuModel.uid %>"><img src="<%#string.IsNullOrEmpty(Eval("pic").ToString())?"../images/noimg.png":("../corpimg/s/"+Eval("pic"))%>" style="width:87px;"/></a>
            </div>
        ...
        <div class="nMainRig">
        	<div class="nRighTitleMessageIco">当前位置：首页 > 产品展示</div>
                <div class="hzsymainNews">
                    <ul>
                    <asp:Repeater ID="rptXinwen" runat="server">
                     <ItemTemplate>
                          <li><a href="prodectdetail.aspx?uid=<%#Eval("uid") %>&id=<%#Eval("id") %>" title="<%#Eval("title") %>"><%#StringClass.CutString(Eval("title").ToString(), 36)%></a>
